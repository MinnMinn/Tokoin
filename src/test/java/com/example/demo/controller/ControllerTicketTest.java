...
public class ControllerTicketTest {
    ...
    @Test
    public void handle_getTicketByString_Success(){
        User[] users = new User[]{
                user1, user2
        };
        ...
        List<Ticket> ticketList = controllerTicket.getTicketByString(users, tickets, organizations, "_id", "b07a8c20-2ee5-493b-9ebf-f6321b95966e");
        assertThat(ticketList).isNotEmpty();
    }

    @Test
    public void handle_getTicketByString_FailedWithDataNotEnough(){
        User[] users = new User[]{
        };
        ...
        List<Ticket> ticketList = controllerTicket.getTicketByString(users, tickets, organizations, "_id", "b07a8c20-2ee5-493b-9ebf-f6321b95966e");
        assertThat(ticketList).isNotSameAs(ticketShow);
    }

    @Test
    public void handle_getTicketByString_FailedWithDataNotFound(){
        User[] users = new User[]{
                user1, user2
        };
        ...
        List<Ticket> ticketList = controllerTicket.getTicketByString(users, tickets, organizations, "_id", "");
