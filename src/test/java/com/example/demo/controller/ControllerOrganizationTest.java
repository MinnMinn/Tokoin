...
public class ControllerOrganizationTest {
    @InjectMocks
    ...
    @Test
    public void handle_getOrganizationByInteger_Success(){
        User[] users = new User[]{
                user1, user2
        };
        ...
        List<Organization> organizationList = controllerOrganization.getOrganizationByInteger(users, tickets, organizations, "_id", 101);
        assertThat(organizationList).isNotEmpty();
    }

    @Test
    public void handle_getOrganizationByInteger_FailedWithDataNotEnough(){
        User[] users = new User[]{
                user1, user2
        };
        ...
        List<Organization> organizationList = controllerOrganization.getOrganizationByInteger(users, tickets, organizations, "_id", 101);
        assertThat(organizationList).isNotSameAs(organizationShow);
    }

    @Test
    public void handle_getOrganizationByInteger_FailedWithDataNotFound(){
        User[] users = new User[]{
                user1, user2
        };
        ...
        List<Organization> organizationList = controllerOrganization.getOrganizationByInteger(users, tickets, organizations, "_id", 10);
        assertThat(organizationList).isEmpty();
